		...
		if($id > 0){
			...
			if($data->canDelete() == true){
				if($result == 0){
					...
					echo Text::pageTitle("Delete Configuration");
					?>
					...
					<form name="adminForm" id="adminForm" method="post" action="<?php echo Url::getAdminHttpBase(); ?>/index.php?option=development&act=configGenerator&task=delete&id=<?php echo $id; ?>&result=1">
