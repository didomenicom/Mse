		...
		if($id > 0){
			...
			if($data->canDelete() == true){
				if($result == 0){
					...
					echo Text::pageTitle("Delete Help Menu");
					?>
					...
					<form name="adminForm" id="adminForm" method="post" action="<?php echo Url::getAdminHttpBase(); ?>/index.php?option=development&act=help&task=delete&id=<?php echo $id; ?>&result=1">
				...
				if($result == 1){
					...
					if($data->delete() == true){
						Messages::setMessage("Help Menu Deleted", Define::get("MessageLevelSuccess"));
					}
					
					Url::redirect(Url::getAdminHttpBase() . "/index.php?option=development&act=help&task=manage", 0, false);
				}
			} else {
				Messages::setMessage("Cannot delete help menu", Define::get("MessageLevelError"));
				Url::redirect(Url::getAdminHttpBase() . "/index.php?option=development&act=help&task=manage", 0, false);
			}
		} else {
